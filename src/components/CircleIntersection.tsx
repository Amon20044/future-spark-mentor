  ...
  return (
    <section className="py-16 md:py-24 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        {/* Desktop version - Circles with intersection */}
        <div className="relative min-h-[400px] my-24 hidden md:block">
          {/* Circles Container */}
        ...
        {/* Mobile version - Vertical blocks with connecting lines */}
        <div className="md:hidden space-y-12 my-16">
          <div className="flex flex-col items-center">
            {/* Mobile Circle 1: My Interest */}
            <div className="w-48 h-48 bg-brand-red/20 border-2 border-brand-red rounded-full mb-4 flex flex-col items-center justify-center">
              <div className="w-12 h-12 bg-brand-red/30 rounded-full flex items-center justify-center mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-brand-red" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                </svg>
              </div>
              <h3 className="text-lg font-bold text-brand-red">My Interest</h3>
            </div>
            
            {/* Connection Line */}
            <div className="w-1 h-12 bg-gradient-to-b from-brand-red to-brand-blue"></div>
            
            {/* Mobile Circle 2: My Skills */}
            <div className="w-48 h-48 bg-brand-blue/20 border-2 border-brand-blue rounded-full mb-4 flex flex-col items-center justify-center">
              <div className="w-12 h-12 bg-brand-blue/30 rounded-full flex items-center justify-center mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-brand-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
              </div>
              <h3 className="text-lg font-bold text-brand-blue">My Skills</h3>
            </div>
            
            {/* Connection Line */}
            <div className="w-1 h-12 bg-gradient-to-b from-brand-blue to-brand-cyan"></div>
            
            {/* Mobile Circle 3: My Stars */}
            <div className="w-48 h-48 bg-brand-cyan/20 border-2 border-brand-cyan rounded-full mb-4 flex flex-col items-center justify-center">
              <div className="w-12 h-12 bg-brand-cyan/30 rounded-full flex items-center justify-center mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-brand-cyan" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                </svg>
              </div>
              <h3 className="text-lg font-bold text-brand-cyan">My Stars</h3>
            </div>
            
            {/* Connection Line */}
            <div className="w-1 h-12 bg-gradient-to-b from-brand-cyan to-gray-400"></div>
